...
public class Exercises {
	...
	/* 
	 ...
	 return 0 if neither a or b are >= 10 or <=20
	 else return whichever is larger, a or b
	 */
	...
	/*
	 ...
	 if it's the weekend and cigars >= 40, return true
	 if it's not the weekend and cigars are >= 40 but <=60, return true
	...
	/*
	 ...
	 if isSummer, then temp <= 100 && temp >= 60, true
	 if not summer, if temp is <= 90 && >= 60, true
	 else false
	 */
