...
public class Exercises {
	...
	{
		String dancingQueen = new String (a + b + b +a);
	...
	{
		String htmlTag = new String ("<" + tag + ">" + word + "</" + tag + ">" );
	...
	{
		String strungOut = new String (out.substring(0,2) + word + out.substring(2,4));
	...
	{
		String noChars = str.substring(1, (str.length() -1));
	...
	{
		String garbageBarge = a.substring(1) + b.substring(1);
	...
	{
		String rotLeft = str.substring(2) + str.substring(0,2);
	...
	public String right2(String str) 
	{
		...
		String rotRight = str.substring( (str.length() -2), str.length()) 
