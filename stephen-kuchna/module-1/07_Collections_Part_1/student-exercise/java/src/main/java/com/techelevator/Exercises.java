...
public class Exercises {
	...
	public List<String> no4LetterWords(String[] stringArray) 
	{
		...
		List<String> listWithNoFourLetters = new ArrayList<String>();
			
			for (int i = 0; i < stringArray.length; i++)
			{
				if (stringArray[i].length() != 4) // if contains no 4 letter words return all words
				{
				listWithNoFourLetters.add(stringArray[i]); 
				}
			}
			// if contains 4 letter words remove them
			return listWithNoFourLetters;
	...
	{
		List<Double> dividedDubs = new ArrayList<Double>();
		
		for (Integer newDub: intArray) 
		{
			
			dividedDubs.add(newDub /2.0 );
		}
	...
	{
		int intMax = Collections.max(integerList);
...
//	{
//		for (Integer intToFind : integerList)
//		{
//			if ( >= 2) 
//			{
//				return true;
...
//		}
	...
	should be replaced by the String "Fizz", any multiple of 5 should be replaced by > String "Buzz",
