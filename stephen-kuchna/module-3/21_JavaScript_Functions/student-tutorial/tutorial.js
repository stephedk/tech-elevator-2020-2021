...
function mapArrayToDoubleAllNumbers(arrayToDouble) {
  return arrayToDouble.map(n => n * 2);
}
 ...
 * 
 * Function for converting temperatures from C to F or F to C;
 * 
 * @param {number} convertTemperature
 * @returns {string} in converted temp
 * 
 */
