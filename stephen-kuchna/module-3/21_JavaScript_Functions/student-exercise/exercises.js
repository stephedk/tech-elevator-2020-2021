...
let unfilteredArray = [1, 2, 3, 4, 5, 6];
    ...
    function useParameterToFilterArray(filterFunction){
        ...
        filteredArray = unfilteredArray.filter((i) =>{return filterFunction(i)});
...
function addAll(...num){
    ...
    if(num !=0){
    let answer = num.reduce((x,y) =>{return x + y;});
 ...
 */
 ...
 const makeHappy = (words) => {
  ...
  /*   function makeHappy(words){
    ...
    return words.map(n => 'Happy' + n);

    const newWords = words.map(n => 'Happy ' + n);
