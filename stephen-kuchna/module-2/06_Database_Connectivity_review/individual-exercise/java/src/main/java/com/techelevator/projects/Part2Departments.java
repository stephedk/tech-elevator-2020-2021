...
public class Part2Departments
{
    ...
    public void run()
    {
        ...
        addDepartment(5, "Widget Department"); 
        addDepartment(6, "Blump's Pig Newtons"); 
        addDepartment(18, "Shippididdy Shippididdy Shap"); 
        addDepartment(19, "Birmingham School Of Buisness School"); 
        ...
        searchForDepartmentByName("birm");
        searchForDepartmentByName("ship");
        searchForDepartmentByName("blump");
